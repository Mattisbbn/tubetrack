    ...
    <footer id="footer" className="bg-dark-900 border-t border-dark-700/50 py-12 px-6 cursor-default-must">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md">
              La solution simple et efficace pour suivre l'évolution de toutes vos playlists YouTube préférées en un
              seul endroit.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-dark-700/50 mt-12 pt-8 flex items-center justify-between">
          <p className="text-gray-400">© 2025 TubeTrack. Tous droits réservés.</p>
