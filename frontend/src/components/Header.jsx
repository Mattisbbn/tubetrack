...
export function Header() {
  return (
    <header
      id="header"
      className="bg-dark-900/80 backdrop-blur-lg border-b border-dark-700/50 sticky top-0 z-50 cursor-default-must">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/playlists" className="text-gray-300 hover:text-white transition-colors cursor-pointer">
              Mes Playlists
            </Link>
