...
export function PlaylistCard({ playlist }) {
  return (
    <Link to={`/playlists/${playlist.uuid}`} className="bg-dark-800/50 backdrop-blur-lg rounded-2xl p-6 border border-dark-700/50 card-hover group section-clickable">
