    ...
    return(
        ...
        <main className="bg-dark-950 min-h-screen">
          ...
          <section id="playlists-main" className="py-8 px-6 cursor-default-must    relative">
            ...
            <div id="filters-section" className="flex flex-wrap items-center justify-between gap-4 mb-8 section-clickable">
                ...
                <div className="flex items-center space-x-2">
                    <button className="bg-dark-700/50 hover:bg-dark-700 text-white p-2 rounded-xl border border-dark-600 transition-colors">
                        <svg className="svg-inline--fa fa-table-cells-large" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table-cells-large" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M448 96V224H288V96H448zm0 192V416H288V288H448zM224 224H64V96H224V224zM64 288H224V416H64V288zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path></svg> <i className="fa-solid fa-th-large"></i> 
                    </button>
                    <button className="text-gray-400 hover:text-white p-2 rounded-xl transition-colors">
                        <svg className="svg-inline--fa fa-list" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="list" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M40 48C26.7 48 16 58.7 16 72v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V72c0-13.3-10.7-24-24-24H40zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zM16 232v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V232c0-13.3-10.7-24-24-24H40c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V392c0-13.3-10.7-24-24-24H40z"></path></svg> <i className="fa-solid fa-list"></i> 
                    </button>
                </div>
            </div>
        </div>

        <div id="playlists-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 cursor-default-must section-clickable">
