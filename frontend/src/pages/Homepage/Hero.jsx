...
export function Hero({ setPlaylists, playlists }) {
  ...
  return (
    <section
      id="hero-section"
      className="relative py-20 px-6 overflow-hidden h-[600px] flex items-center cursor-default-must  bg-gradient-to-br from-slate-900/20 via-dark-900 to-gray-900/20">
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <div
          ...
          <p className="text-gray-400 mb-6">Collez le lien de votre playlist YouTube pour commencer</p>
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className=" cursor-pointer w-full bg-slate-700 hover:bg-slate-600 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
